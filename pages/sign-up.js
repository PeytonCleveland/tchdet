      ...
      >
        <div className='backdrop-blur-2xl bg-gradient-to-br from-slate-800/40 to-slate-900/60'>
          <div className='container h-screen flex flex-col items-center py-44 relative'>
            <div className='bg-slate-800 xl:w-2/5 lg:w-1/2 md:w-4/5 rounded-md flex flex-col px-8 py-5 space-y-5 w-full border border-slate-600'>
              <h1 className='mb-2 text-lg text-slate-100 md:text-lg'>
              ...
              <div>
                ...
                <div className='flex items-center'>
                  ...
                  <input
                    ...
                    name='email'
                    id='email'
                    className='outline-none py-2 text-base ml-2 w-full bg-transparent'
                    placeholder='Email@domain.com'
                    value={email}
                    onChange={(e) => setEmail(e.target.value)}
                  />
                  {!validEmail && (
                    <Button onClick={() => setValidEmail(true)}>
                      Continue
                    </Button>
                  )}
                </div>
              ...
              {validEmail && (
                <div>
                  <p className='text-sky-400'>Create a password</p>
                  <div className='flex items-center'>
                    <svg
                      xmlns='http://www.w3.org/2000/svg'
                    ...
                    >
                      {!visiblePassword ? (
                        <svg
                          xmlns='http://www.w3.org/2000/svg'
                          className='h-5 w-5 text-slate-100 mr-6'
                          viewBox='0 0 20 20'
                          fill='currentColor'
                        >
            ...
            <p className='absolute bottom-8 text-xs w-2/5 text-center text-slate-500'>
